<x-app-layout>
    ...
    <div class="min-h-screen
                bg-gradient-to-b from-[#f4f9ff] via-white to-[#eef7ff]
                py-7">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white
                ...
                <div class="relative overflow-hidden
                    ...
                    <div class="absolute -right-4 -bottom-28
                                w-72 h-72
                                bg-white/5
                                rounded-full">
                    </div>
                        ...
                        <div class="flex flex-col sm:flex-row
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm sm:text-base
                                    ...
                                    Perbarui informasi sub kategori arsip.
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-blue-100 mb-0.5">
                                        Sub kategori yang sedang diedit
                                    </p>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-0.5">
                                        Perbarui nama sub kategori sesuai kebutuhan.
                                    </p>
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                       name="name"
                                       id="name"
                                       value="{{ old('name', $subcategory->sub_category) }}"
                                       required
                            ...
                            @else
                                <p class="mt-2 text-xs text-gray-500">
                                    Pastikan nama sub kategori mudah dikenali.
                                </p>
                            @enderror
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs
                                            ...
                                            atau kosongkan keduanya jika
                                            sub kategori tidak menggunakan
                                            metode pembayaran maupun sumber dana.
                                ...
                                <div class="group
                                    ...
                                    <select name="payment_method"
                                        ...
                                        @foreach ($payment as $pay)
                                            ...
                                            <option value="{{ $pay->id }}"
                                                {{ old('payment_method', $subcategory->payment_method_id) == $pay->id ? 'selected' : '' }}>
                                ...
                                <div class="group
                                    ...
                                    <select name="funding_source"
                                        ...
                                        @foreach ($funding as $fun)
                                            ...
                                            <option value="{{ $fun->id }}"
                                                {{ old('funding_source', $subcategory->funding_source_id) == $fun->id ? 'selected' : '' }}>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs
                                        ...
                                        sudah sesuai. Sub kategori tetap
                                        berada di bawah kategori
            ...
            <div class="mt-5 text-center">
                ...
                <p class="text-xs text-gray-400">
                    Perubahan sub kategori akan mengikuti kategori induk yang sedang dipilih.
                </p>
