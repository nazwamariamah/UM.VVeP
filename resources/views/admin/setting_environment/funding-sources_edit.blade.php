        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-0.5">
                    Perbarui informasi sumber dana
                </p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Perbarui data sumber dana yang sudah tersimpan di sistem.
                </p>
            ...
            <div class="bg-white rounded-3xl border border-blue-100
                ...
                <div class="relative overflow-hidden
                    ...
                    <div class="absolute -right-10 -top-16
                        w-48 h-48 rounded-full bg-white/10"></div>

                    <div class="absolute -right-2 -bottom-20
                        w-40 h-40 rounded-full bg-white/10"></div>

                    <div class="absolute left-1/2 -top-20
                        w-32 h-32 rounded-full bg-white/5"></div>
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-100 mt-1">
                                Perbarui informasi sumber dana agar tetap akurat.
                            </p>
                ...
                {{-- FORM --}}
                <form action="{{ route('funding.update', $fundingSource->id) }}"
                    method="POST"
