<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4 anim-fade-in">
            ...
            <div class="hidden sm:flex w-12 h-12 rounded-2xl
    ...
    <div class="py-8
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative overflow-hidden
                       ...
                       shadow-2xl
                       shadow-blue-200/60
                       mb-7 anim-fade-in anim-delay-1">
                ...
                <div class="absolute top-8 right-40
                           w-20 h-20
                           bg-white/5
                           rounded-full
                           blur-sm">
            ...
            <div class="relative overflow-hidden
                       ...
                       shadow-xl
                       shadow-gray-200/50
                       mb-7 anim-fade-in anim-delay-2">
            ...
            <div class="mb-7 anim-fade-in anim-delay-3">
                       ...
                       class="report-card report-card-blue group">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm
                                   ...
                                   leading-relaxed
                                   mt-2">
                                Buat laporan semua pengajuan yang dibuat UM.
                            </p>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex
                                ...
                                <h4 class="text-base
                                           ...
                                           transition-colors">
                                    Laporan Pengajuan Diverifikasi
                                </h4>
                            ...
                            <p class="text-sm
                                   ...
                                   leading-relaxed
                                   mt-2">
                                Laporan pengajuan yang sudah diverifikasi.
                            </p>
            ...
            <div class="bg-white/95
                       ...
                       shadow-xl
                       shadow-gray-200/50
                       overflow-hidden anim-fade-in anim-delay-4">
    ...
    <style>
        ...
        /* =========================================================
            SUBMISSION CARD STAGGER ANIMATION
        ========================================================= */

        .submission-card {
            animation: reportFadeIn 0.45s ease-out both;
        }
